        ...
        <nav className="nav">
          ...
          <div className="nav__actions">
            ...
            <button className="btn btn--primary">
              <Link className="nav__link nav__link--signup" to="/signup">
                Sign Up
              </Link>
            </button>
          </div>
        ...
        <section className="hero">
          <div className="hero__content">
            ...
            <p className="hero__description">
              Unlock your full potential. Join a vibrant community for
              collaborative study sessions, AI-powered summaries, and endless
              resources.
            </p>
          ...
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-header__description">
                Our platform is packed with features to boost your productivity.
              </p>
            </div>
            ...
            <div className="features__grid">
              <div className="feature-card">
                ...
                <p className="feature-card__description">
                  Collaborate in real-time with peers. Share notes, tackle
                  problems, and stay motivated in virtual study rooms.
                </p>
              </div>
              <div className="feature-card">
                <h3 className="feature-card__title">AI-Powered Summaries</h3>
                <p className="feature-card__description">
                  Instantly condense long articles and documents into key points
                  with our smart AI summarizer. Study smarter, not harder.
                </p>
              </div>
              <div className="feature-card">
                <h3 className="feature-card__title">Resource Sharing</h3>
                <p className="feature-card__description">
                  Access a vast library of notes, practice exams, and guides
                  shared by the community. Find what you need, when you need it.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="testimonials__grid">
              <div className="testimonial-card">
                <p className="testimonial-card__text">
                  "StudyHub has transformed my study habits. The group sessions
                  keep me accountable, and the AI summaries are a lifesaver
                  during exam season!"
                </p>
              ...
              <div className="testimonial-card">
                <p className="testimonial-card__text">
                  "I love the resource sharing feature. It's amazing to have
                  access to a wide range of study materials from different
                  students. It's like having a study group always available."
                </p>
                <div className="testimonial-card__author">
                  <img
                    alt="Student photo"
              ...
              <div className="testimonial-card">
                <p className="testimonial-card__text">
                  "The platform is so easy to use and the community is
                  incredibly supportive. I've made new friends and improved my
                  grades thanks to StudyHub."
                </p>
                <div className="testimonial-card__author">
                  <img
                    alt="Student photo"
            ...
            <div className="community__content">
              ...
              <div className="community__text">
                ...
                <p className="community__description">
                  Don't study alone. Connect with thousands of students, form
                  study groups, and conquer your courses together. Your next
                  study buddy is just a click away.
                </p>
                <button className="btn btn--primary btn--large">
                  Find Your Group
                </button>
